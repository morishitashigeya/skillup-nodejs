...
このファイルは[EJS](http://ejs.co/)で書かれています。
EJSとはHTMLを効率よく書くことができるテンプレートエンジンです。
EJSについては[テンプレートエンジンEJSで使える便利な構文まとめ](http://qiita.com/y_hokkey/items/31f1daa6cecb5f4ea4c9)が参考になります。
